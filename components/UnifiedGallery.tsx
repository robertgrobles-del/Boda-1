...
// Foto del encabezado ("Captura los momentos") que se muestra partida en dos mitades.
        ...
        <section id={id} className="relative min-h-screen overflow-hidden bg-cream py-20">
            ...
            <div className="mx-auto mb-12 w-full max-w-7xl px-6 text-center md:mb-20 lg:px-32 lg:text-left">
                <div className="grid grid-cols-1 items-center gap-10 md:gap-16 lg:grid-cols-2">
                    ...
                    >
                        {/* imagen_2 partida por la mitad: izquierda = el novio, derecha = la novia */}
                        <div className="grid h-full grid-cols-2 overflow-hidden rounded-3xl border-4 border-white shadow-xl">
                            ...
                            >
                                <img
                                    ...
                                    alt="Dalvin"
                                    loading="lazy"
                                    className="absolute left-0 top-0 h-full w-[200%] max-w-none object-cover object-[50%_62%]"
                                />
                            </button>
                            <button
                                onClick={() => setLightboxIndex(0)}
                            ...
                            >
                                <img
                                    ...
                                    alt="Stephanie"
                                    loading="lazy"
                                    className="absolute right-0 top-0 h-full w-[200%] max-w-none object-cover object-[50%_62%]"
                                />
                            </button>
                        </div>
