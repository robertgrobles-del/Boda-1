    ...
    <section className="min-h-[60vh] h-full flex items-start justify-center pt-16 pb-16 min-[481px]:pt-32 min-[481px]:pb-32 bg-white relative border-b border-stone-100">
      <div className="max-w-4xl mx-auto px-6 w-full">
        <div className="text-center mb-8 min-[481px]:mb-10">
          <h2 className="font-serif text-3xl min-[481px]:text-4xl lg:text-5xl text-olive">Código de Vestimenta</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0 relative">
          ...
          >
            <div className="w-16 h-16 min-[481px]:w-20 min-[481px]:h-20 bg-[#f1f4ea] rounded-full flex items-center justify-center mb-6 min-[481px]:mb-8">
              <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 min-[481px]:w-10 min-[481px]:h-10 text-olive" stroke="currentColor" strokeWidth="1.5">
            ...
            <p className="text-stone-600 text-[11px] min-[481px]:text-xs leading-relaxed max-w-[200px]">
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
              {['#4a5d23', '#b35a44', '#c9b79c', '#8a9bb0', '#6d5b6b'].map((c) => (
                <span key={c} className="h-5 w-5 rounded-full border border-white shadow-sm" style={{ backgroundColor: c }} />
              ))}
            </div>
          </motion.div>
        </div>
